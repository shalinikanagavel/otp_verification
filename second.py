...
label1=Label(Window,text="Verification Screen",relief="solid",font=("arial",15,"bold"),fg='green').pack(fill=BOTH)
a=StringVar()
Re=Label(Window,text="Enter your Otp",font=("arial",10,"bold")).place(x=50,y=50)
w1=Entry(Window,width=20,textvariable=a)
w1.place(x=150,y=50)
Re1=Label(Window,text="Please enter within 2 minutes",font=("arial",10,"bold")).place(x=80,y=100)
ver = Button(Window, text="Verify",relief="raised", bg='blue', font=("arial", 15, "bold"), fg='white',command=verify).place(x=125,y=150)
Window.mainloop()